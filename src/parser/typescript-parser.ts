 ...
 */
function createTSParser(): Parser {
 ...
 */
function createTSXParser(): Parser {
  const parser = new Parser()
...
function extractImplements(
  ...
  const implementations: ImplementInfo[] = []
 ...
 */
function buildInterfaceImportMap(rootNode: Parser.SyntaxNode): Map<string, string> {
 ...
 */
function extractClassName(classNode: Parser.SyntaxNode): string | null {
 ...
 */
function extractInterfaceNames(classNode: Parser.SyntaxNode): string[] {
